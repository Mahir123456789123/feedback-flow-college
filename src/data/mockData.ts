...
export const mockGrievances: Grievance[] = [
  {
    ...
    examName: 'Internal Assessment 1',
    questionNumber: 3,
    grievanceText: 'I believe my solution for the binary tree traversal question deserves more marks. I have implemented all three traversal methods (inorder, preorder, postorder) correctly with proper time complexity analysis.',
    status: 'pending',
    teacherId: 'teacher1',
    teacherName: 'Dr. Priya Sharma',
